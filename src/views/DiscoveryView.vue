                            ...
                            <div class="col d-flex justify-content-center flex-wrap">
                                ...
                                <div v-for="game in store.games" class="game_card border-0 rounded-3 shadow-lg mx-2 my-3">
                                    <div class="icons d-flex justify-content-between">
                                        <div class="add_want_to_play rounded-circle ms-1 mt-1 mb-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="25" fill="currentColor"
                                                class="bi bi-heart-fill" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                                                    d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                                            </svg>
                                            <!-- <div class="popup_to_play">Aggiungi a 'Da Giocare'</div> -->
                                        </div>
                                        <div class="add_actually_play rounded-circle me-1 mt-1 mb-1">
                                            ...
                                            <!-- <div class="popup_actually_play">Aggiungi a 'Sto Giocando a'</div> -->
                                        </div>
                                    </div>
